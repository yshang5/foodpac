...
import { getCurrentUser, loginWithGoogle, logout } from './auth.js?v=20260728s';
import { initOnboarding } from './onboarding.js?v=20260728s';
import { initDropdowns } from './dropdown.js?v=20260728s';
import { avatarHtml } from './avatar.js?v=20260728s';
import { API_BASE } from './api.js?v=20260728s';
