...
import { getCurrentUser, loginWithGoogle, logout } from './auth.js?v=20260727j';
import { avatarHtml } from './avatar.js?v=20260727j';
import { API_BASE } from './api.js?v=20260727j';
