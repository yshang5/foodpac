...
import { getCurrentUser, loginWithGoogle, logout } from './auth.js?v=20260727m';
import { avatarHtml } from './avatar.js?v=20260727m';
import { API_BASE } from './api.js?v=20260727m';
