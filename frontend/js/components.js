...
import { getCurrentUser, loginWithGoogle, logout } from './auth.js?v=20260728a';
import { avatarHtml } from './avatar.js?v=20260728a';
import { API_BASE } from './api.js?v=20260728a';
