...
import { getCurrentUser, loginWithGoogle, logout } from './auth.js?v=20260727l';
import { avatarHtml } from './avatar.js?v=20260727l';
import { API_BASE } from './api.js?v=20260727l';
